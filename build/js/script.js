...
function count(){time+=1}function timer(){setInterval(count,6e4)}function preload(i){$(i).each(function(){$("<img/>")[0].src=this})}$(function(){$(window).bind("resize",function(){resizeMe()}).trigger("resize")});var resizeMe=function(){var i=2550,n=10,e=$(window).width(),t=e/i,g=n*t;$("html").css("font-size",g)},time=0;preload(["img/fair.png","img/texture.png","img/library.png","img/factory.png","img/front-bg.jpg","img/card-game.png","img/win-bg.jpg"]);})